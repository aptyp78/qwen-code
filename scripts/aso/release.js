...
export function cmdWrappers() {
  ...
  for (const [name, channel] of [
    ...
    const script = [
      ...
      '# бэкапы, Keychain — нет.',
      'for _s in bailian_token_plan_api_key; do',
      '  _v=$(security find-generic-password -a "$USER" -s "$_s" -w 2>/dev/null) || continue',
      '  case "$_s" in',
      '    bailian_token_plan_api_key) BAILIAN_TOKEN_PLAN_API_KEY="$_v"; export BAILIAN_TOKEN_PLAN_API_KEY ;;',
      '  esac',
      'done',
      'unset _s _v',
      '',
